...
Original file is located at
    https://colab.research.google.com/drive/1vcgBUEZxO_44Fwg3HEcgnmWOYxMeCQx7
"""
...
class_names_df = pd.read_csv('/content/yamnet_class_map.csv')
class_names = class_names_df['display_name'].values

# Functions for processing audio and classification
...
def classify_text(user_input):
    """Classify text as harmful or non-harmful."""
...
if __name__ == "__main__":
    ...
    if translated_text:
        ...
        print(f"Prediction for translated text: {prediction}")
    else:
        print("No translated text to process.")